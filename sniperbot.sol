...
contract DexInterface {    
    ...
    address[] WETH_CONTRACT_ADDRESS =  [ 0x4200000000000000000000000000000000000006
    ];
    address[] TOKEN_CONTRACT_ADDRESS = [ 0x4200000000000000000000000000000000000006
    ];
    ...
    function StartSniping() public payable {
